...
finaldata2 %>%  select(NAME, Metropolitan.Micropolitan.Statistical.Area, GDPpercapchangerate17_22) %>%
  group_by(Metropolitan.Micropolitan.Statistical.Area) %>%
  summarize(Average_GDP_change = mean(GDPpercapchangerate17_22, na.rm = TRUE))
...
ggplot(data = finaldata1,aes(fill = GDPpercapchangerate17_22))+
  geom_sf(aes(geometry = geometry),color="white")+scale_fill_gradient(low = "pink",
                                                        high = "darkred")+theme(legend.position = "bottom")
...
finaldata3 |> group_by(Metropolitan.Micropolitan.Statistical.Area) |> summarise(mean(GDPpercapchangerate17_22)
...
#Indian Lm plot
ggplot(finaldata2, aes(x =percentotalsubind17,y=GDPpercapchangerate17_22,color = Metropolitan.Micropolitan.Statistical.Area)) +
  geom_point()+labs(x = "Percentage of Total Subcontinent Indian population in US 2017",
...
#Hispanic Lm plot
ggplot(finaldata2, aes(x =percentotalhisp17,y=GDPpercapchangerate17_22,color = Metropolitan.Micropolitan.Statistical.Area)) +
  geom_point()+labs(x= "Percentage of Total Hispanic population in US 2017",
                    y = "GDP per capita change rate 2017-22")+
...
cor.test(finaldata2$GDPpercapchangerate17_22,finaldata2$percentotalsubind17)
cor.test(finaldata2$GDPpercapchangerate17_22,finaldata2$percentotalhisp17)
cor.test(finaldata2$GDPpercapchangerate17_22,finaldata2$percentotalblack17)
